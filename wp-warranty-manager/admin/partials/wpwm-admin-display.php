...
<div class="wrap">
                ...
                <?php foreach ( $results as $row ) : ?>
                    <tr>
                        ...
                        <td>
                                ...
                                href="<?php echo esc_url( admin_url( 'admin.php?page=warranty-edit&id=' . $row->id ) ); ?>"
                                class="button button-small"
                                style="margin-left:5px;"
                            >✏️ <?php esc_html_e( 'Edit', 'wp-warranty-manager' ); ?></a>
    ...
    <?php if ( $total_pages > 1 ) : ?>
        <div style="margin-top:20px;display:flex;align-items:center;gap:6px;flex-wrap:wrap;">
            ...
            if ( $start > 1 ) { echo '<span style="padding:4px 8px;">...</span>'; }
            for ( $i = $start; $i <= $end; $i++ ) :
            ?>
            ...
            <?php endfor; ?>
            <?php if ( $end < $total_pages ) { echo '<span style="padding:4px 8px;">...</span>'; } ?>
